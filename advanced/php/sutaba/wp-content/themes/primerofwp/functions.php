<?php
/**
 * Primer of WP functions and definitions
 *
...
function twentytwenty_theme_support() {
	 ...
	 * If you're building a theme based on Primer of WP, use a find and replace
...
function twentytwenty_get_elements_array() {
	...
	$elements = array(
		...
		'header-footer' => array(
			...
			'background' => array(
				...
				'background-color' => array( '#site-header', '.footer-nav-widgets-wrapper', '.menu-modal', '.menu-modal-inner', '.search-modal-inner', '.archive-header', '.singular .entry-header', '.entry-header', '.singular .featured-media:before', '.wp-block-pullquote:before' ),
			),
			'text'       => array(
	...
	/**
	* Filters Primer of WP theme elements
	*
	* @since 1.0.0
	*
